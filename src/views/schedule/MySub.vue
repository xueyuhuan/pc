            ...
            <card>
                ...
                <div class="content">
                    <div v-for="item in zxlm" v-if="item.subFlag === '1'" class="block">
                        ...
                        <div class="block_hover _theme_font" @click="cancelSub(item.id)"><span><i class="fa fa-minus-circle"></i>&nbsp;取消订阅</span>
                        </div>
                    </div>
                </div>
            </card>
            ...
            <card>
                ...
                <div class="content">
                    <div v-for="item in zxlm" v-if="item.subFlag === '0'" class="block">
                        <div class="block_title"><span>{{item.name}}</span></div>
                        <div class="block_hover _theme_font" @click="saveSub(item.id)"><span><i class="fa fa-plus-circle"></i>&nbsp;我要订阅</span>
                        </div>
                    </div>
                </div>
            </card>
